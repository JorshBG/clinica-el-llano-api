...
<li class="nav-item">
  ...
  <span class="mt-1 ms-1 sidebar-text">Inventarios (Productos)</span>
  </a>
              ...
              <div class="multi-level collapse  show " role="list" id="submenu-app" aria-expanded="false">
                  ...
                  <li class="nav-item">
                    <span class="sidebar-icon">
                      ...
                      <a class="nav-link" href="../../pages/tables/unidadesMedida.html">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
                      ...
                      <li class="nav-item">
                          <a class="nav-link d-flex align-items-center" href="/dashboard/view/ventas">
                              ...
                              <span class="mt-1 ms-1 sidebar-text">Ventas</span>
                          </a>
                      </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-houses-fill" viewBox="0 0 16 16">
                      ...
                      <a class="nav-link" href="">
                          <span class="sidebar-text">Almácenes</span>
                      </a>
                  </li>
              </ul>
              <br>
                  ...
                  <div class="multi-level collapse  show " role="list" id="submenu-app" aria-expanded="false">
                      ...
                      <li class="nav-item">
                        <a class="nav-link d-flex align-items-center" href="/dashboard/view/ordenes">
                            ...
                            <span class="mt-1 ms-1 sidebar-text">Ordenes de compra</span>
                        </a>
                    </li>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-up-fill" viewBox="0 0 16 16">
                          ...
                          <a class="nav-link" href="">
                              <span class="sidebar-text">Entradas de almácen(Enlace a Entradas de almacén)</span>
                          </a>
              </ul>
              <br>
                  ...
                  <ul class="nav-item">
                      <div class="multi-level collapse  show " role="list" id="submenu-app" aria-expanded="false">
                          ...
                          <span class="sidebar-text">Administración de almacenes</span>
                          ...
                          <li class="nav-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-seam" viewBox="0 0 16 16">
                              ...
                              <a class="nav-link" href="../../pages/tables/unidadesMedida.html">
                                  <span class="sidebar-text">Entradas de productos (almácen)</span>
                              </a>
                          </li>
                          <li class="nav-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-right" viewBox="0 0 16 16">
                              ...
                              <a class="nav-link" href="presentacion.html">
                                  <span class="sidebar-text">Traspasos</span>
                              </a>
                          </li>
                          <li class="nav-item">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
                              ...
                              <a class="nav-link" href="../../pages/tables/unidadesMedida.html">
                                  <span class="sidebar-text">Salidas (Ventas)</span>
                              </a>
              </ul>
                      </div>
  ...
  <li class="nav-item">
      <a class="nav-link d-flex align-items-center" href="/dashboard/view/usuarios">
          ...
          <span class="mt-1 ms-1 sidebar-text">Usuarios</span>
      </a>
  </li>
          ...
          <ul class="flex-column nav">
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center" href="/dashboard/view/traslados">
                      ...
                      <span class="mt-1 ms-1 sidebar-text">Traslados</span>
                  </a>
              </li>
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex align-items-center" href="/dashboard/view/consumos">
                      ...
                      <span class="mt-1 ms-1 sidebar-text">Consumos</span>
                  </a>
              </li>
      </ul>
   </div>
