...
<li class="nav-item">
  ...
  <span class="sidebar-icon">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-speedometer"
        ...
        <span class="mt-1 ms-1 uyjdebar-text">Dashboard</span>
    </a>
</li>
...
<li class="nav-item">
            <span
                ...
                <span>
                    ...
                    <span class="sidebar-text">Catálogo</span> </span><span class="link-arrow"><svg
                        class="icon icon-sm"
    ...
    <div
        ...
        <ul class="flex-column nav">
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    href="/dashboard/views/catalogo/presentacion"
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    href="/dashboard/views/catalogo/presentacion"
                ><span class="sidebar-text">Provedores</span></a
                >
            </li>
...
<li class="nav-item">
            <span
                ...
                <span>
                    ...
                    <!--     TEXTO DEL DROPDOWN ANTES DE ABRIRSE       -->
                    <span class="sidebar-text">Compras</span> </span><span class="link-arrow"><svg
                        class="icon icon-sm"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <ul class="flex-column nav">
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    href="/dashboard/views/catalogo/presentacion"
                ><span class="sidebar-text">Orden de compra</span></a
                >
            </li>
...
<li class="nav-item">
            <span
                ...
                <span>
                    ...
                    <!--     TEXTO DEL DROPDOWN ANTES DE ABRIRSE       -->
                    <span class="sidebar-text">Administración de almacenes</span> </span><span class="link-arrow"><svg
                        class="icon icon-sm"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <ul class="flex-column nav">
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    href="/dashboard/views/catalogo/presentacion"
                ><span class="sidebar-text">Entradas de productos</span></a
                >
            </li>
            ...
            <li class="nav-item">
                <a
                    class="nav-link"
                    href="/dashboard/views/catalogo/presentacion"
                ><span class="sidebar-text">Traspasos</span></a
                >
            </li>
