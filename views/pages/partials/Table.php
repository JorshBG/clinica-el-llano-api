        ...
        <div class="col col-md-6 col-lg-3 col-xl-4">
            <div class="input-group me-2 me-lg-3 fmxw-400">
                <span class="input-group-text"><svg class="icon icon-xs" x-description="Heroicon name: solid/search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    </svg> </span><input type="text" class="form-control" placeholder="Buscar <?php echo $dataName?>" />
            </div>
        </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-end pb-0">
                    ...
                    <a class="dropdown-item d-flex align-items-center fw-bold" href="#">10
                        ...
                        </svg></a><a class="dropdown-item fw-bold" href="#">20</a>
...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="border-gray-200">Almacen de origen</th>
                <th class="border-gray-200">Almacen de destino</th>
                <th class="border-gray-200">Fecha de inicio</th>
                <th class="border-gray-200">Fecha de término</th>
                <th class="border-gray-200">Total de productos</th>
    ...
    <div class="card-footer px-3 border-0 d-flex flex-column flex-lg-row align-items-center justify-content-between">
        ...
        <div class="fw-normal small mt-4 mt-lg-0">
            Mostrando <b><span id="dashboard_tables-data"></span></b> de <b><span id="dashboard_tables-total-data"></span></b>
        </div>
    </div>
</div>