...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" placeholder="producto de ejemplo" id="form_product-name" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="text" class="form-control" placeholder="Ibuprofeno" id="form_product-activeSustance" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="number" pattern="[0-9]+\.?[0-9]*" class="form-control" placeholder="600.87" id="form_product-cost" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="number" pattern="[0-9]+\.?[0-9]*" class="form-control" placeholder="500.65" id="form_product-uniteCost" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="number" pattern="[0-9]+" class="form-control" placeholder="500" id="form_product-content" autofocus required />
    </div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="number" pattern="[0-9]+\.?[0-9]*" class="form-control" id="form_product-discount" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <textarea class="form-control" placeholder="Descríbelo..." id="form_product-description" autofocus required></textarea>
</div>