...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="number" pattern="[0-9]+" class="form-control" id="form_outputs-folio" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <select class="form-select" id="form_outputs-patient" aria-label="Output patient select">
        </select>
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <input type="date" class="form-control" id="form_outputs-date" autofocus required />
    </div>
</div>
...
<div class="form-group mb-4">
    ...
    <div class="input-group">
        ...
        <select class="form-select" id="form_outputs-user" aria-label="Output user select">
        </select>
    </div>
</div>